const CACHE = 'guardian-dragon-art-v68';
const CORE = [
  '/',
  '/index.html',
  ...
  '/core/res/world/visual-novel.js?v=13',
  '/core/res/world/app.js?v=31',
  '/core/res/world/engine.js?v=13',
