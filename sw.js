const CACHE = 'guardian-dragon-art-v26';
const CORE = [
  '/',
  '/index.html',
  ...
  '/core/res/world/app.css?v=20',
  '/core/res/world/menu-shell.js?v=11',
