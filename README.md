...
底下跑的是一套无头叙事运行时，所以世界书条目、正则替换、触发脚本、提示词预设、长程记忆这一整套都是真的在工作，不是摆设。正文出来之后想改一处措辞，写条正则就行；想给模型加一条只有你知道的规矩，写条世界书就行。

### 世界书

![世界书](docs/shots/book.webp)

这一纪送进模型的东西全在这里摊开着，按 **世界 · 共同背景 / 规则 · 正典 / 规则 · 时代边界 / 规则 · 叙事 / 人物 · 身份与身体 / 人物 · 经历与能力 / 人物 · 判断发动机 / 人物 · 声口与心声 / 人物 · 关系后果** 分门别类；次要人物也使用同一套五项档案。一条一条都能点开看正文。看得见，才知道模型为什么这么写。想加自己的设定，「自写条目」或者直接汇入一份 JSON。
...
程序代码以 MIT 许可开放。游戏文本、设定数据与美术素材**不在** MIT 范围内——这是一部同人作品，原作的一切权利属于其作者与版权方。第三方组件（叙事运行时、three.js、字体）各自遵循原始许可。详见 [LICENSE](LICENSE)。
