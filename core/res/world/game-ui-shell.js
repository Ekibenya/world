(function(){
  ...
  function renderBook(){
    ...
    var labels={'event':'事件','world-fact':'世界设定','continuity':'连续性','unresolved':'未解决事项','character-state':'主角龙状态','knowledge-boundary':'知识边界','secondary-character':'次要人物','premise':'时代边界'};
    var order=['event','world-fact','continuity','unresolved','character-state','knowledge-boundary','secondary-character','premise'];
