...
}, s = /^in(stanceof)?$/, c = RegExp("[" + r + "]"), l = RegExp("[" + r + n + "]");
function u(e, t) {
...
function d(e, n) {
	return e < 65 ? e === 36 : e < 91 ? !0 : e < 97 ? e === 95 : e < 123 ? !0 : e <= 65535 ? e >= 170 && c.test(String.fromCharCode(e)) : n === !1 ? !1 : u(e, t);
}
function f(n, r) {
	return n < 48 ? n === 36 : n < 58 ? !0 : n < 65 ? !1 : n < 91 ? !0 : n < 97 ? n === 95 : n < 123 ? !0 : n <= 65535 ? n >= 170 && l.test(String.fromCharCode(n)) : r === !1 ? !1 : u(n, t) || u(n, e);
}
var p = function(e, t) {
...
var h = { beforeExpr: !0 }, g = { startsExpr: !0 }, _ = {};
function v(e, t) {
	return t === void 0 && (t = {}), t.keyword = e, _[e] = new p(e, t);
}
var y = {
	num: new p("num", g),
	regexp: new p("regexp", g),
	string: new p("string", g),
	name: new p("name", g),
	privateId: new p("privateId", g),
	eof: new p("eof"),
	bracketL: new p("[", {
		beforeExpr: !0,
		startsExpr: !0
...
function te(e, t, n) {
	...
	for (var r = t; r < n; r++) {
		...
		if (x(i)) return r < n - 1 && i === 13 && e.charCodeAt(r + 1) === 10 ? r + 2 : r + 1;
	}
	return -1;
}
var ne = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/, S = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g, re = Object.prototype, ie = re.hasOwnProperty, ae = re.toString, C = Object.hasOwn || (function(e, t) {
	return ie.call(e, t);
}), oe = Array.isArray || (function(e) {
	return ae.call(e) === "[object Array]";
}), se = Object.create(null);
function w(e) {
	return se[e] || (se[e] = RegExp("^(?:" + e.replace(/ /g, "|") + ")$"));
}
function T(e) {
...
function fe(e) {
	var t = {};
	for (var n in ue) t[n] = e && C(e, n) ? e[n] : ue[n];
	if (t.ecmaVersion === "latest" ? t.ecmaVersion = 1e8 : t.ecmaVersion == null ? (!de && typeof console == "object" && console.warn && (de = !0, console.warn("Since Acorn 8.0.0, options.ecmaVersion is required.\nDefaulting to 2020, but this will stop working in the future.")), t.ecmaVersion = 11) : t.ecmaVersion >= 2015 && (t.ecmaVersion -= 2009), t.allowReserved ??= t.ecmaVersion < 5, (!e || e.allowHashBang == null) && (t.allowHashBang = t.ecmaVersion >= 14), oe(t.onToken)) {
		var r = t.onToken;
		t.onToken = function(e) {
			return r.push(e);
		};
	}
	return oe(t.onComment) && (t.onComment = pe(t, t.onComment)), t;
}
function pe(e, t) {
...
var O = 1, k = 2, me = 4, he = 8, ge = 16, _e = 32, ve = 64, ye = 128, A = 256, j = 512, be = O | k | A;
function xe(e, t) {
	return k | (e ? me : 0) | (t ? he : 0);
}
var M = 0, Se = 1, N = 2, Ce = 3, we = 4, Te = 5, P = function(e, t, n) {
	this.options = e = fe(e), this.sourceFile = e.sourceFile, this.keywords = w(o[e.ecmaVersion >= 6 ? 6 : e.sourceType === "module" ? "5module" : 5]);
	var r = "";
	e.allowReserved !== !0 && (r = i[e.ecmaVersion >= 6 ? 6 : e.ecmaVersion === 5 ? 5 : 3], e.sourceType === "module" && (r += " await")), this.reservedWords = w(r);
	var a = (r ? r + " " : "") + i.strict;
	this.reservedWordsStrict = w(a), this.reservedWordsStrictBind = w(a + " " + i.strictBind), this.input = String(t), this.containsEsc = !1, n ? (this.pos = n, this.lineStart = this.input.lastIndexOf("\n", n - 1) + 1, this.curLine = this.input.slice(0, this.lineStart).split(b).length) : (this.pos = this.lineStart = 0, this.curLine = 1), this.type = y.eof, this.value = null, this.start = this.end = this.pos, this.startLoc = this.endLoc = this.curPosition(), this.lastTokEndLoc = this.lastTokStartLoc = null, this.lastTokStart = this.lastTokEnd = this.pos, this.context = this.initialContext(), this.exprAllowed = !0, this.inModule = e.sourceType === "module", this.strict = this.inModule || this.strictDirective(this.pos), this.potentialArrowAt = -1, this.potentialArrowInForAwait = !1, this.yieldPos = this.awaitPos = this.awaitIdentPos = 0, this.labels = [], this.undefinedExports = Object.create(null), this.pos === 0 && e.allowHashBang && this.input.slice(0, 2) === "#!" && this.skipLineComment(2), this.scopeStack = [], this.enterScope(O), this.regexpState = null, this.privateNameStack = [];
}, F = {
...
var De = { kind: "loop" }, Oe = { kind: "switch" };
R.isLet = function(e) {
	if (this.options.ecmaVersion < 6 || !this.isContextual("let")) return !1;
	S.lastIndex = this.pos;
	var t = S.exec(this.input), n = this.pos + t[0].length, r = this.input.charCodeAt(n);
	if (r === 91 || r === 92) return !0;
	if (e) return !1;
	if (r === 123 || r > 55295 && r < 56320) return !0;
	if (d(r, !0)) {
		for (var i = n + 1; f(r = this.input.charCodeAt(i), !0);) ++i;
		if (r === 92 || r > 55295 && r < 56320) return !0;
		var a = this.input.slice(n, i);
	...
	return !b.test(this.input.slice(this.pos, t)) && this.input.slice(t, t + 8) === "function" && (t + 8 === this.input.length || !(f(n = this.input.charCodeAt(t + 8)) || n > 55295 && n < 56320));
	...
	if (e) {
		var i = r + 5, a;
		if (this.input.slice(r, i) !== "using" || i === this.input.length || f(a = this.input.charCodeAt(i)) || a > 55295 && a < 56320) return !1;
		S.lastIndex = i;
		var o = S.exec(this.input);
		if (o && b.test(this.input.slice(i, i + o[0].length))) return !1;
	}
	if (t) {
		var s = r + 2, c;
		if (this.input.slice(r, s) === "of" && (s === this.input.length || !f(c = this.input.charCodeAt(s)) && !(c > 55295 && c < 56320))) return !1;
	}
	var l = this.input.charCodeAt(r);
	return d(l, !0) || l === 92;
	...
	return this.next(), this.labels.push(De), e.body = this.parseStatement("do"), this.labels.pop(), this.expect(y._while), e.test = this.parseParenExpression(), this.options.ecmaVersion >= 6 ? this.eat(y.semi) : this.semicolon(), this.finishNode(e, "DoWhileStatement");
}, R.parseForStatement = function(e) {
	this.next();
	var t = this.options.ecmaVersion >= 9 && this.canAwait && this.eatContextual("await") ? this.lastTokStart : -1;
	if (this.labels.push(De), this.enterScope(0), this.expect(y.parenL), this.type === y.semi) return t > -1 && this.unexpected(t), this.parseFor(e, null);
	var n = this.isLet();
	...
	var l = this.containsEsc, u = new L(), d = this.start, f = t > -1 ? this.parseExprSubscripts(u, "await") : this.parseExpression(!0, u);
	...
	return (this.type === y._in || this.options.ecmaVersion >= 6 && this.isContextual("of")) && t.declarations.length === 1 ? (this.options.ecmaVersion >= 9 && (this.type === y._in ? n > -1 && this.unexpected(n) : e.await = n > -1), this.parseForIn(e, t)) : (n > -1 && this.unexpected(n), this.parseFor(e, t));
}, R.parseFunctionStatement = function(e, t, n) {
	return this.next(), this.parseFunction(e, z | (n ? 0 : Ae), !1, t);
	...
	this.next(), e.discriminant = this.parseParenExpression(), e.cases = [], this.expect(y.braceL), this.labels.push(Oe), this.enterScope(0);
...
R.parseCatchClauseParam = function() {
	...
	return this.enterScope(t ? _e : 0), this.checkLValPattern(e, t ? we : N), this.expect(y.parenR), e;
	...
	return this.next(), e.test = this.parseParenExpression(), this.labels.push(De), e.body = this.parseStatement("while"), this.labels.pop(), this.finishNode(e, "WhileStatement");
	...
	e.id = t === "using" || t === "await using" ? this.parseIdent() : this.parseBindingAtom(), this.checkLValPattern(e.id, t === "var" ? Se : N, !1);
};
var z = 1, Ae = 2, je = 4;
R.parseFunction = function(e, t, n, r, i) {
	this.initFunction(e), (this.options.ecmaVersion >= 9 || this.options.ecmaVersion >= 6 && !r) && (this.type === y.star && t & Ae && this.unexpected(), e.generator = this.eat(y.star)), this.options.ecmaVersion >= 8 && (e.async = !!r), t & z && (e.id = t & je && this.type !== y.name ? null : this.parseIdent(), e.id && !(t & Ae) && this.checkLValSimple(e.id, this.strict || e.generator || e.async ? this.treatFunctionsAsVar ? Se : N : Ce));
	...
	for (i.body = [], this.expect(y.braceL); this.type !== y.braceR;) {
		...
		o && (i.body.push(o), o.type === "MethodDefinition" && o.kind === "constructor" ? (a && this.raiseRecoverable(o.start, "Duplicate constructor in the same class"), a = !0) : o.key && o.key.type === "PrivateIdentifier" && Me(r, o) && this.raiseRecoverable(o.key.start, "Identifier '#" + o.key.name + "' has already been declared"));
	}
	...
	if (r ? (n.computed = !1, n.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), n.key.name = r, this.finishNode(n.key, "Identifier")) : this.parseClassElementName(n), t < 13 || this.type === y.parenL || o !== "method" || i || a) {
		var l = !n.static && Ne(n, "constructor"), u = l && e;
	...
	var i = e.key;
	e.kind === "constructor" ? (t && this.raise(i.start, "Constructor can't be a generator"), n && this.raise(i.start, "Constructor can't be an async method")) : e.static && Ne(e, "prototype") && this.raise(i.start, "Classes may not have a static property named prototype");
	...
	return Ne(e, "constructor") ? this.raise(e.key.start, "Classes can't have a field named 'constructor'") : e.static && Ne(e, "prototype") && this.raise(e.key.start, "Classes can't have a static field named 'prototype'"), this.eat(y.eq) ? (this.enterScope(j | ve), e.value = this.parseMaybeAssign(), this.exitScope()) : e.value = null, this.semicolon(), this.finishNode(e, "PropertyDefinition");
}, R.parseClassStaticBlock = function(e) {
	e.body = [];
	var t = this.labels;
	for (this.labels = [], this.enterScope(A | ve); this.type !== y.braceR;) {
		var n = this.parseStatement(null);
		e.body.push(n);
	}
	return this.next(), this.exitScope(), this.labels = t, this.finishNode(e, "StaticBlock");
}, R.parseClassId = function(e, t) {
	this.type === y.name ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, N, !1)) : (t === !0 && this.unexpected(), e.id = null);
	...
	if (this.options.checkPrivateFields) for (var r = this.privateNameStack.length, i = r === 0 ? null : this.privateNameStack[r - 1], a = 0; a < n.length; ++a) {
		var o = n[a];
		C(t, o.name) || (i ? i.used.push(o) : this.raiseRecoverable(o.start, "Private field '#" + o.name + "' must be declared in an enclosing class"));
	}
};
function Me(e, t) {
...
R.parseExportAllDeclaration = function(e, t) {
	...
	if (this.type === y._function || (e = this.isAsyncFunction())) {
		var t = this.startNode();
		return this.next(), e && this.next(), this.parseFunction(t, z | je, !1, e);
	...
	e && (typeof t != "string" && (t = t.type === "Identifier" ? t.name : t.value), C(e, t) && this.raiseRecoverable(n, "Duplicate export '" + t + "'"), e[t] = !0);
	...
	return this.next(), this.type === y.string ? (e.specifiers = ke, e.source = this.parseExprAtom()) : (e.specifiers = this.parseImportSpecifiers(), this.expectContextual("from"), e.source = this.type === y.string ? this.parseExprAtom() : this.unexpected()), this.options.ecmaVersion >= 16 && (e.attributes = this.parseWithClause()), this.semicolon(), this.finishNode(e, "ImportDeclaration");
	...
	for (var t = {}, n = !0; !this.eat(y.braceR);) {
		...
		C(t, i) && this.raiseRecoverable(r.key.start, "Duplicate attribute key '" + i + "'"), t[i] = !0, e.push(r);
	}
	return e;
	...
	if (this.options.ecmaVersion >= 13 && this.type === y.string) {
		...
		return ce.test(e.value) && this.raise(e.start, "An export name cannot include a lone surrogate."), e;
	}
...
B.toAssignable = function(e, t, n) {
	...
	switch (e.type) {
		case "Identifier":
			this.strict && this.reservedWordsStrictBind.test(e.name) && this.raiseRecoverable(e.start, (r ? "Binding " : "Assigning to ") + e.name + " in strict mode"), r && (t === N && e.name === "let" && this.raiseRecoverable(e.start, "let is disallowed as a lexically bound name"), n && (C(n, e.name) && this.raiseRecoverable(e.start, "Argument name clash"), n[e.name] = !0), t !== Te && this.declareName(e.name, t, e.start));
			break;
		case "ChainExpression":
			this.raiseRecoverable(e.start, "Optional chaining cannot appear in left-hand side");
			break;
...
U.initialContext = function() {
	...
	return t === H.f_expr || t === H.f_stat ? !0 : e === y.colon && (t === H.b_stat || t === H.b_expr) ? !t.isExpr : e === y._return || e === y.name && this.exprAllowed ? b.test(this.input.slice(this.lastTokEnd, this.start)) : e === y._else || e === y.semi || e === y.eof || e === y.parenR || e === y.arrow ? !0 : e === y.braceL ? t === H.b_stat : e === y._var || e === y._const || e === y.name ? !1 : !this.exprAllowed;
	...
	e.beforeExpr && e !== y._else && !(e === y.semi && this.curContext() !== H.p_stat) && !(e === y._return && b.test(this.input.slice(this.lastTokEnd, this.start))) && !((e === y.colon || e === y.braceL) && this.curContext() === H.b_stat) ? this.context.push(H.f_expr) : this.context.push(H.f_stat), this.exprAllowed = !1;
...
W.checkPropClash = function(e, t, n) {
	...
	if (this.type === y.comma) {
		...
		for (a.expressions = [i]; this.eat(y.comma);) a.expressions.push(this.parseMaybeAssign(e, t));
	...
	var r = !1, i = -1, a = -1, o = -1;
	t ? (i = t.parenthesizedAssign, a = t.trailingComma, o = t.doubleProto, t.parenthesizedAssign = t.trailingComma = -1) : (t = new L(), r = !0);
	...
	if (this.isContextual("await") && this.canAwait) o = this.parseAwait(r), t = !0;
		...
		s.operator = this.value, s.prefix = !0, this.next(), s.argument = this.parseMaybeUnary(null, !0, c, r), this.checkExpressionErrors(e, !0), c ? this.checkLValSimple(s.argument) : this.strict && s.operator === "delete" && Pe(s.argument) ? this.raiseRecoverable(s.start, "Deleting local variable in strict mode") : s.operator === "delete" && Fe(s.argument) ? this.raiseRecoverable(s.start, "Private fields can not be deleted") : t = !0, o = this.finishNode(s, c ? "UpdateExpression" : "UnaryExpression");
...
function Pe(e) {
	return e.type === "Identifier" || e.type === "ParenthesizedExpression" && Pe(e.expression);
}
function Fe(e) {
	return e.type === "MemberExpression" && e.property.type === "PrivateIdentifier" || e.type === "ChainExpression" && Fe(e.expression) || e.type === "ParenthesizedExpression" && Fe(e.expression);
}
W.parseExprSubscripts = function(e, t) {
	...
	if (l || c && this.type !== y.parenL && this.type !== y.backQuote || this.eat(y.dot)) {
		...
		var d = new L(), f = this.yieldPos, p = this.awaitPos, m = this.awaitIdentPos;
	...
	switch (this.type) {
		...
		case y.name:
			...
			if (this.options.ecmaVersion >= 8 && !s && c.name === "async" && !this.canInsertSemicolon() && this.eat(y._function)) return this.overrideContext(H.f_expr), this.parseFunction(this.startNodeAt(a, o), 0, !1, !0, t);
		...
		case y.braceL: return this.overrideContext(H.b_expr), this.parseObj(!1, e);
	...
	if (this.options.ecmaVersion >= 6) {
		this.next();
		var o = this.start, s = this.startLoc, c = [], l = !0, u = !1, d = new L(), f = this.yieldPos, p = this.awaitPos, m;
...
W.parseNew = function() {
	...
	return e.callee = this.parseSubscripts(this.parseExprAtom(null, !1, !0), r, i, !0, !1), this.eat(y.parenL) ? e.arguments = this.parseExprList(y.parenR, this.options.ecmaVersion >= 8, !1) : e.arguments = Ie, this.finishNode(e, "NewExpression");
	...
	if (i) e.body = this.parseMaybeAssign(r), e.expression = !0, this.checkParams(e, !1);
		...
		var c = this.labels;
		this.labels = [], o && (this.strict = !0), this.checkParams(e, !a && !o && !t && !n && this.isSimpleParamList(e.params)), this.strict && e.id && this.checkLValSimple(e.id, Te), e.body = this.parseBlock(!1, void 0, o && !a), e.expression = !1, this.adaptDirectivePrologue(e.body.body), this.labels = c;
	}
	this.exitScope();
	...
	for (var n = Object.create(null), r = 0, i = e.params; r < i.length; r += 1) {
		var a = i[r];
		this.checkLValInnerPattern(a, Se, t ? null : n);
	}
...
K.enterScope = function(e) {
	...
	if (t === N) {
	...
	} else if (t === we) this.currentScope().lexical.push(e);
	else if (t === Ce) {
		...
		if (s.var.push(e), this.inModule && s.flags & O && delete this.undefinedExports[e], s.flags & be) break;
	}
	...
	for (var e = this.scopeStack.length - 1;; e--) {
		...
		if (t.flags & (be | j | A)) return t;
	}
}, K.currentThisScope = function() {
	for (var e = this.scopeStack.length - 1;; e--) {
		var t = this.scopeStack[e];
		if (t.flags & (be | j | A) && !(t.flags & ge)) return t;
	}
};
var q = function(e, t, n) {
	this.type = "", this.start = t, this.end = 0, e.options.locations && (this.loc = new D(e, n)), e.options.directSourceFile && (this.sourceFile = e.options.directSourceFile), e.options.ranges && (this.range = [t, 0]);
}, J = P.prototype;
...
}, J.finishNodeAt = function(e, t, n, r) {
	return Re.call(this, e, t, n, r);
}, J.copyNode = function(e) {
	var t = new q(this, e.start, this.startLoc);
	for (var n in e) t[n] = e[n];
	return t;
};
var ze = "Gara Garay Gukh Gurung_Khema Hrkt Katakana_Or_Hiragana Kawi Kirat_Rai Krai Nag_Mundari Nagm Ol_Onal Onao Sunu Sunuwar Todhri Todr Tulu_Tigalari Tutg Unknown Zzzz", Be = "ASCII ASCII_Hex_Digit AHex Alphabetic Alpha Any Assigned Bidi_Control Bidi_C Bidi_Mirrored Bidi_M Case_Ignorable CI Cased Changes_When_Casefolded CWCF Changes_When_Casemapped CWCM Changes_When_Lowercased CWL Changes_When_NFKC_Casefolded CWKCF Changes_When_Titlecased CWT Changes_When_Uppercased CWU Dash Default_Ignorable_Code_Point DI Deprecated Dep Diacritic Dia Emoji Emoji_Component Emoji_Modifier Emoji_Modifier_Base Emoji_Presentation Extender Ext Grapheme_Base Gr_Base Grapheme_Extend Gr_Ext Hex_Digit Hex IDS_Binary_Operator IDSB IDS_Trinary_Operator IDST ID_Continue IDC ID_Start IDS Ideographic Ideo Join_Control Join_C Logical_Order_Exception LOE Lowercase Lower Math Noncharacter_Code_Point NChar Pattern_Syntax Pat_Syn Pattern_White_Space Pat_WS Quotation_Mark QMark Radical Regional_Indicator RI Sentence_Terminal STerm Soft_Dotted SD Terminal_Punctuation Term Unified_Ideograph UIdeo Uppercase Upper Variation_Selector VS White_Space space XID_Continue XIDC XID_Start XIDS", Ve = Be + " Extended_Pictographic", He = Ve, Ue = He + " EBase EComp EMod EPres ExtPict", We = Ue, Ge = We, Ke = {
	9: Be,
	10: Ve,
	11: He,
	12: Ue,
	13: We,
	14: Ge
}, qe = "Basic_Emoji Emoji_Keycap_Sequence RGI_Emoji_Modifier_Sequence RGI_Emoji_Flag_Sequence RGI_Emoji_Tag_Sequence RGI_Emoji_ZWJ_Sequence RGI_Emoji", Je = {
	9: "",
	10: "",
	11: "",
	12: "",
...
function it(e) {
	var t = rt[e] = {
		binary: w(Ke[e] + " " + Ye),
		binaryOfStrings: w(Je[e]),
		nonBinary: {
			General_Category: w(Ye),
			Script: w(nt[e])
		}
	};
...
var Y = P.prototype, ct = function(e, t) {
	this.parent = e, this.base = t || this;
};
ct.prototype.separatedFrom = function(e) {
	for (var t = this; t; t = t.parent) for (var n = e; n; n = n.parent) if (t.base === n.base && t !== n) return !0;
	return !1;
}, ct.prototype.sibling = function() {
	return new ct(this.parent, this.base);
};
var X = function(e) {
...
Y.validateRegExpPattern = function(e) {
	this.regexp_pattern(e), !e.switchN && this.options.ecmaVersion >= 9 && lt(e.groupNames) && (e.switchN = !0, this.regexp_pattern(e));
	...
	for (t && (e.branchID = new ct(e.branchID, null)), this.regexp_alternative(e); e.eat(124);) t && (e.branchID = e.branchID.sibling()), this.regexp_alternative(e);
	...
	for (var t = "", n = 0; (n = e.current()) !== -1 && ut(n);) t += T(n), e.advance();
	return t;
};
function ut(e) {
...
Y.regexp_eatExtendedAtom = function(e) {
	...
	var t = e.current();
	return dt(t) ? (e.lastIntValue = t, e.advance(), !0) : !1;
};
function dt(e) {
	return e === 36 || e >= 40 && e <= 43 || e === 46 || e === 63 || e >= 91 && e <= 94 || e >= 123 && e <= 125;
}
Y.regexp_eatPatternCharacters = function(e) {
	for (var t = e.pos, n = 0; (n = e.current()) !== -1 && !dt(n);) e.advance();
	return e.pos !== t;
	...
	if (e.lastStringValue = "", this.regexp_eatRegExpIdentifierStart(e)) {
		for (e.lastStringValue += T(e.lastIntValue); this.regexp_eatRegExpIdentifierPart(e);) e.lastStringValue += T(e.lastIntValue);
		return !0;
	}
	return !1;
...
Y.regexp_eatCharacterClassEscape = function(e) {
	var t = e.current();
	if (_t(t)) return e.lastIntValue = -1, e.advance(), Z;
	var n = !1;
...
Y.regexp_eatUnicodePropertyValueExpression = function(e) {
	...
	C(e.unicodeProperties.nonBinary, t) || e.raise("Invalid property name"), e.unicodeProperties.nonBinary[t].test(n) || e.raise("Invalid property value");
	...
	var t = 0;
	for (e.lastStringValue = ""; vt(t = e.current());) e.lastStringValue += T(t), e.advance();
...
Y.regexp_eatUnicodePropertyValue = function(e) {
	var t = 0;
	for (e.lastStringValue = ""; yt(t = e.current());) e.lastStringValue += T(t), e.advance();
	return e.lastStringValue !== "";
};
function yt(e) {
	return vt(e) || Ct(e);
...
Y.regexp_eatLoneUnicodePropertyNameOrValue = function(e) {
	...
	if (e.eat(92)) {
		...
		if (e.switchU) {
			var n = e.current();
			(n === 99 || Et(n)) && e.raise("Invalid class escape"), e.raise("Invalid escape");
		}
		e.pos = t;
	}
	var r = e.current();
	...
	var n = e.current();
	return n < 0 || n === e.lookahead() && bt(n) || xt(n) ? !1 : (e.advance(), e.lastIntValue = n, !0);
};
function bt(e) {
...
Y.regexp_eatClassControlLetter = function(e) {
	...
	var t = e.pos, n = 0;
	for (e.lastIntValue = 0; Ct(n = e.current());) e.lastIntValue = 10 * e.lastIntValue + (n - 48), e.advance();
	return e.pos !== t;
};
function Ct(e) {
	return e >= 48 && e <= 57;
...
Y.regexp_eatHexDigits = function(e) {
	var t = e.pos, n = 0;
	for (e.lastIntValue = 0; wt(n = e.current());) e.lastIntValue = 16 * e.lastIntValue + Tt(n), e.advance();
	return e.pos !== t;
};
function wt(e) {
...
$.next = function(e) {
	...
	if (n === -1 && this.raise(this.pos - 2, "Unterminated comment"), this.pos = n + 2, this.options.locations) for (var r = void 0, i = t; (r = te(this.input, i, this.pos)) > -1;) ++this.curLine, i = this.lineStart = r;
	...
	for (var t = this.pos, n = this.options.onComment && this.curPosition(), r = this.input.charCodeAt(this.pos += e); this.pos < this.input.length && !x(r);) r = this.input.charCodeAt(++this.pos);
	...
	loop: for (; this.pos < this.input.length;) {
		...
		switch (e) {
			...
			case 47:
				...
				break;
			default: if (e > 8 && e < 14 || e >= 5760 && ne.test(String.fromCharCode(e))) ++this.pos;
			else break loop;
		}
	}
	...
	if (e >= 13 && (++this.pos, t = this.fullCharCodeAtPos(), d(t, !0) || t === 92)) return this.finishToken(y.privateId, this.readWord1());
...
$.readRadixNumber = function(e) {
	...
	return n ?? this.raise(this.start + 2, "Expected number in radix " + e), this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110 ? (n = kt(this.input.slice(t, this.pos)), ++this.pos) : d(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(y.num, n);
	...
	if (!n && !e && this.options.ecmaVersion >= 11 && r === 110) {
		...
		return ++this.pos, d(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(y.num, i);
	}
	...
	for (var t = "", n = ++this.pos;;) {
		...
		var r = this.input.charCodeAt(this.pos);
		if (r === e) break;
		r === 92 ? (t += this.input.slice(n, this.pos), t += this.readEscapedChar(!1), n = this.pos) : r === 8232 || r === 8233 ? (this.options.ecmaVersion < 10 && this.raise(this.start, "Unterminated string constant"), ++this.pos, this.options.locations && (this.curLine++, this.lineStart = this.pos)) : (x(r) && this.raise(this.start, "Unterminated string constant"), ++this.pos);
	}
...
$.tryReadTemplateToken = function() {
	...
	switch (++this.pos, t) {
		...
		case 117: return T(this.readCodePoint());
		case 116: return "	";
		case 98: return "\b";
		case 118: return "\v";
		case 102: return "\f";
		...
		default:
			...
			return x(t) ? (this.options.locations && (this.lineStart = this.pos, ++this.curLine), "") : String.fromCharCode(t);
	}
	...
	for (var e = "", t = !0, n = this.pos, r = this.options.ecmaVersion >= 6; this.pos < this.input.length;) {
		...
		if (f(i, r)) this.pos += i <= 65535 ? 1 : 2;
		else if (i === 92) {
			this.containsEsc = !0, e += this.input.slice(n, this.pos);
			var a = this.pos;
			this.input.charCodeAt(++this.pos) !== 117 && this.invalidStringToken(this.pos, "Expecting Unicode escape sequence \\uXXXX"), ++this.pos;
			var o = this.readCodePoint();
			(t ? d : f)(o, r) || this.invalidStringToken(a, "Invalid Unicode escape"), e += T(o), n = this.pos;
		} else break;
		t = !1;
	}
	...
	return this.keywords.test(e) && (t = _[e]), this.finishToken(t, e);
};
var jt = "8.15.0";
P.acorn = {
	Parser: P,
...
//#endregion
export { q as Node, P as Parser, E as Position, D as SourceLocation, V as TokContext, Dt as Token, p as TokenType, ue as defaultOptions, le as getLineInfo, f as isIdentifierChar, d as isIdentifierStart, x as isNewLine, _ as keywordTypes, b as lineBreak, ee as lineBreakG, ne as nonASCIIwhitespace, Mt as parse, Nt as parseExpressionAt, H as tokContexts, y as tokTypes, Pt as tokenizer, jt as version };
